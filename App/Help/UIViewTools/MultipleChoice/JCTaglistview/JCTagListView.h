...
@property (nonatomic, strong) UIColor *tagSelectedStrokeColor;//default:lightGrayColor
...
@property (nonatomic, strong, readonly) NSMutableArray *selecIndexArray;

@property (nonatomic, strong) UICollectionView *collectionView;

@property (nonatomic, assign) NSInteger selectCount;//max canSelect
