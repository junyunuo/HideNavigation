...
#define Min_Width_4_Button 375/6
...
//        }
        ...
        //  bottom lineView
        //
        _bottomLineView = [[UIView alloc] initWithFrame:CGRectMake(width4btn / 4, HYSegmentedControl_Height-2, width4btn / 2, 2.0f)];
        _bottomLineView.backgroundColor = [UIColor mainColor];
...
- (void)segmentedControlChange:(UIButton *)btn
{
    ...
    rect4boottomLine.origin.x = btn.gq_centerX - self.bottomLineView.gq_width/2;
