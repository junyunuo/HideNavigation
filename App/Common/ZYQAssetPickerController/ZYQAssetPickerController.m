...
- (void)setupButtons
{
    ...
    NSString* itemTitle=@"完成";
    if(![NSString isBlankString:self.rightButtonTitle]){
        itemTitle=self.rightButtonTitle;
    }
    self.navigationItem.rightBarButtonItem =
    [[UIBarButtonItem alloc] initWithTitle:NSLocalizedString(itemTitle,nil)
...
- (void)finishPickingAssets:(id)sender
{
    ...
    [defaultCenter addObserver:self
                      selector:@selector(uploadPictureSuccess)
                          name:@"uploadPictureSuccess"
                        object:nil];
...
- (id)init
{
    ...
    groupViewController.rightButtonTitle=rightButtonTitle;
